...
export const AuthConfigSchema = z.object({
  ...
  gameOrigin: z.string().url().default('http://127.0.0.1:3001'),
  adminOrigin: z.string().url().default('http://127.0.0.1:3002'),
  apiOrigin: z.string().url().default('http://127.0.0.1:4000'),
